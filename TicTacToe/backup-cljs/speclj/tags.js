...
return cljs.core.not.call(null,cljs.core.some.call(null,(function (p1__9635_SHARP_){
return cljs.core.contains_QMARK_.call(null,excludes,p1__9635_SHARP_);
}),tags));
}
});
...
var context_seq = cljs.core.tree_seq.call(null,(function (p1__9644_SHARP_){
return (!((p1__9644_SHARP_ == null)));
}),(function (p1__9646_SHARP_){
return cljs.core.deref.call(null,p1__9646_SHARP_.children);
}),context);
...
var context_seq = cljs.core.tree_seq.call(null,(function (p1__9648_SHARP_){
return (!((p1__9648_SHARP_ == null)));
}),(function (p1__9649_SHARP_){
return cljs.core.deref.call(null,p1__9649_SHARP_.children);
}),context);
return cljs.core.map.call(null,(function (p1__9650_SHARP_){
return cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword(null,"context","context",-830191113),new cljs.core.Keyword(null,"tag-set","tag-set",-711527597)],[p1__9650_SHARP_,speclj.tags.tags_for.call(null,p1__9650_SHARP_)]);
}),context_seq);
});
