...
return cljs.core.some.call(null,(function (p1__6770_SHARP_){
return f.call(null,p1__6770_SHARP_,v);
}),ev);
} else {
...
var pred__6776 = cljs.core._EQ_;
var expr__6777 = cljs.core.first.call(null,form);
if(cljs.core.truth_(pred__6776.call(null,new cljs.core.Symbol(null,">",">",1085014381,null),expr__6777))){
...
if(cljs.core.truth_(pred__6776.call(null,new cljs.core.Symbol(null,"<","<",993667236,null),expr__6777))){
var v = cljs.core.second.call(null,form);
if(typeof v === 'number'){
...
if(cljs.core.truth_(pred__6776.call(null,new cljs.core.Symbol(null,">=",">=",1016916022,null),expr__6777))){
var v = cljs.core.second.call(null,form);
if(typeof v === 'number'){
...
if(cljs.core.truth_(pred__6776.call(null,new cljs.core.Symbol(null,"<=","<=",1244895369,null),expr__6777))){
var v = cljs.core.second.call(null,form);
if(typeof v === 'number'){
...
if(cljs.core.truth_(pred__6776.call(null,new cljs.core.Symbol(null,"like","like",726481451,null),expr__6777))){
return c3kit.apron.test_fabric.pattern_comparator.call(null,cljs.core.second.call(null,form),true);
} else {
if(cljs.core.truth_(pred__6776.call(null,new cljs.core.Symbol(null,"ilike","ilike",1487249058,null),expr__6777))){
...
if(cljs.core.truth_(pred__6776.call(null,new cljs.core.Symbol(null,"not=","not=",1466536204,null),expr__6777))){
return cljs.core.complement.call(null,c3kit.apron.test_fabric._or_tester.call(null,cljs.core.rest.call(null,form)));
} else {
if(cljs.core.truth_(pred__6776.call(null,new cljs.core.Symbol(null,"=","=",-1501502141,null),expr__6777))){
...
c3kit.apron.test_fabric.kv__GT_tester = (function c3kit$apron$test_fabric$kv__GT_tester(p__6782){
var vec__6783 = p__6782;
var k = cljs.core.nth.call(null,vec__6783,(0),null);
var v = cljs.core.nth.call(null,vec__6783,(1),null);
