...
var G__11618 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__11618,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__11618;
}
}));
...
var len__5726__auto___11623 = arguments.length;
var i__5727__auto___11624 = (0);
while(true){
if((i__5727__auto___11624 < len__5726__auto___11623)){
args__5732__auto__.push((arguments[i__5727__auto___11624]));

var G__11625 = (i__5727__auto___11624 + (1));
i__5727__auto___11624 = G__11625;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq11620){
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,(function (p1__11626_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__11626_SHARP_));
...
var temp__5804__auto___11628 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5804__auto___11628)){
var message_11629 = temp__5804__auto___11628;
cljs.core.println.call(null,message_11629);
} else {
}
...
var temp__5804__auto___11630 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5804__auto___11630)){
var message_11631 = temp__5804__auto___11630;
cljs.core.println.call(null,message_11631);
} else {
}
...
var output_dir__$1 = (function (){var G__11632 = output_dir;
if((!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/")))){
return [G__11632,"/"].join('');
} else {
return G__11632;
}
})();
...
var G__11633 = exception.stack;
var G__11633__$1 = (((G__11633 == null))?null:clojure.string.split_lines.call(null,G__11633));
var G__11633__$2 = (((G__11633__$1 == null))?null:cljs.core.get.call(null,G__11633__$1,depth));
if((G__11633__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__11633__$2);
}
} else {
...
var vec__11634 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__11634,(0),null);
var column = cljs.core.nth.call(null,vec__11634,(1),null);
var vec__11637 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__11637,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__11637,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__11637,(2),null);
...
var m__$1 = (function (){var G__11640 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
var G__11640__$1 = (((G__11640 instanceof cljs.core.Keyword))?G__11640.fqn:null);
switch (G__11640__$1) {
case "fail":
...
var G__11645 = (function (){var G__11643 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__11643);
} else {
return G__11643;
}
})();
...
return cljs.core.vary_meta.call(null,G__11644,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__11649 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__11649,(0),null);
var types = vec__11649;
...
return cljs.core.map.call(null,(function (p__11652){
var vec__11653 = p__11652;
var ns = cljs.core.nth.call(null,vec__11653,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__11653,(1),null);
return (function (){
...
var G__11656 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
var G__11656__$1 = (((G__11656 instanceof cljs.core.Keyword))?G__11656.fqn:null);
switch (G__11656__$1) {
case "async":
...
var seq__11657 = cljs.core.seq.call(null,vars__$1);
var chunk__11658 = null;
var count__11659 = (0);
var i__11660 = (0);
while(true){
if((i__11660 < count__11659)){
var v = cljs.core._nth.call(null,chunk__11658,i__11660);
var temp__5804__auto___11662 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5804__auto___11662)){
var t_11663 = temp__5804__auto___11662;
each_fixture_fn.call(null,((function (seq__11657,chunk__11658,count__11659,i__11660,t_11663,temp__5804__auto___11662,v,each_fixture_fn,G__11656,G__11656__$1,env,once_fixtures,each_fixtures,vec__11653,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_11663)));
});})(seq__11657,chunk__11658,count__11659,i__11660,t_11663,temp__5804__auto___11662,v,each_fixture_fn,G__11656,G__11656__$1,env,once_fixtures,each_fixtures,vec__11653,ns,vars__$1))
);
} else {
}


var G__11664 = seq__11657;
var G__11665 = chunk__11658;
var G__11666 = count__11659;
var G__11667 = (i__11660 + (1));
seq__11657 = G__11664;
chunk__11658 = G__11665;
count__11659 = G__11666;
i__11660 = G__11667;
continue;
} else {
var temp__5804__auto__ = cljs.core.seq.call(null,seq__11657);
if(temp__5804__auto__){
var seq__11657__$1 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__11657__$1)){
var c__5525__auto__ = cljs.core.chunk_first.call(null,seq__11657__$1);
var G__11668 = cljs.core.chunk_rest.call(null,seq__11657__$1);
var G__11669 = c__5525__auto__;
var G__11670 = cljs.core.count.call(null,c__5525__auto__);
var G__11671 = (0);
seq__11657 = G__11668;
chunk__11658 = G__11669;
count__11659 = G__11670;
i__11660 = G__11671;
continue;
} else {
var v = cljs.core.first.call(null,seq__11657__$1);
var temp__5804__auto___11672__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5804__auto___11672__$1)){
var t_11673 = temp__5804__auto___11672__$1;
each_fixture_fn.call(null,((function (seq__11657,chunk__11658,count__11659,i__11660,t_11673,temp__5804__auto___11672__$1,v,seq__11657__$1,temp__5804__auto__,each_fixture_fn,G__11656,G__11656__$1,env,once_fixtures,each_fixtures,vec__11653,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_11673)));
});})(seq__11657,chunk__11658,count__11659,i__11660,t_11673,temp__5804__auto___11672__$1,v,seq__11657__$1,temp__5804__auto__,each_fixture_fn,G__11656,G__11656__$1,env,once_fixtures,each_fixtures,vec__11653,ns,vars__$1))
);
} else {
}


var G__11674 = cljs.core.next.call(null,seq__11657__$1);
var G__11675 = null;
var G__11676 = (0);
var G__11677 = (0);
seq__11657 = G__11674;
chunk__11658 = G__11675;
count__11659 = G__11676;
i__11660 = G__11677;
continue;
}
} else {
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__11656__$1)].join('')));
