...
var periods__$1 = cljs.core.vec.call(null,(function (){var G__13605 = periods;
if(cljs.core.truth_(short_QMARK_)){
return cljs.core.map.call(null,(function (p1__13604_SHARP_){
return cljs.core.subs.call(null,p1__13604_SHARP_,(0),(3));
}),G__13605);
} else {
return G__13605;
}
...
cljs_time.internal.unparse.lookup = (function cljs_time$internal$unparse$lookup(p__13613){
var vec__13614 = p__13613;
var t = cljs.core.nth.call(null,vec__13614,(0),null);
var pattern = cljs.core.nth.call(null,vec__13614,(1),null);
if(cljs.core._EQ_.call(null,t,new cljs.core.Keyword(null,"token","token",-1211463215))){
var G__13617 = pattern;
switch (G__13617) {
case "S":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__13617)].join('')));
...
return p1__13619_SHARP_.getMilliseconds();
});

break;
case "seconds":
return (function (p1__13620_SHARP_){
return p1__13620_SHARP_.getSeconds();
});

break;
case "minutes":
return (function (p1__13621_SHARP_){
return p1__13621_SHARP_.getMinutes();
});

break;
case "hours":
return (function (p1__13622_SHARP_){
return p1__13622_SHARP_.getHours();
});

break;
case "HOURS":
return (function (p1__13623_SHARP_){
return p1__13623_SHARP_.getHours();
});

break;
case "day":
return (function (p1__13624_SHARP_){
return p1__13624_SHARP_.getDate();
});

break;
case "month":
return (function (p1__13625_SHARP_){
return p1__13625_SHARP_.getMonth();
});

break;
case "year":
return (function (p1__13626_SHARP_){
return p1__13626_SHARP_.getYear();
});
...
cljs_time.internal.unparse.lookup_fn = (function cljs_time$internal$unparse$lookup_fn(syntax_list,i,p__13631){
...
var key = first__13634;
var args = seq__13633__$1;
var G__13635 = key;
...
break;
case "ordinal-suffix":
var vec__13638 = syntax_list.call(null,(i - (1)));
...
var d = value;
var G__13645 = cljs.core.map_indexed.call(null,cljs.core.partial.call(null,cljs_time.internal.unparse.lookup_fn,syn_list),syn_list);
var vec__13646 = G__13645;
...
var unparser = first__13648;
var more = seq__13647__$1;
var s = "";
var d__$1 = d;
var G__13645__$1 = G__13645;
var s__$1 = s;
while(true){
var d__$2 = d__$1;
var vec__13657 = G__13645__$1;
var seq__13658 = cljs.core.seq.call(null,vec__13657);
var first__13659 = cljs.core.first.call(null,seq__13658);
var seq__13658__$1 = cljs.core.next.call(null,seq__13658);
var unparser__$1 = first__13659;
var more__$1 = seq__13658__$1;
var s__$2 = s__$1;
if((unparser__$1 == null)){
return s__$2;
} else {
var vec__13660 = unparser__$1.call(null,s__$2,d__$2);
var s__$3 = cljs.core.nth.call(null,vec__13660,(0),null);
var d__$3 = cljs.core.nth.call(null,vec__13660,(1),null);
var G__13670 = d__$3;
var G__13671 = more__$1;
var G__13672 = s__$3;
d__$1 = G__13670;
G__13645__$1 = G__13671;
s__$1 = G__13672;
continue;
}
break;
