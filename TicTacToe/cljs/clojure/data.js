...
return cljs.core.reduce.call(null,(function (result,p__15091){
...
var vec__15095 = clojure.data.diff.call(null,va,vb);
var a_STAR_ = cljs.core.nth.call(null,vec__15095,(0),null);
var b_STAR_ = cljs.core.nth.call(null,vec__15095,(1),null);
var ab = cljs.core.nth.call(null,vec__15095,(2),null);
...
var clojure$data$EqualityPartition$equality_partition$dyn_15112 = (function (x){
...
return clojure$data$EqualityPartition$equality_partition$dyn_15112.call(null,x);
}
});
...
var clojure$data$Diff$diff_similar$dyn_15121 = (function (a,b){
...
return clojure$data$Diff$diff_similar$dyn_15121.call(null,a,b);
}
});
...
return (function (){var G__15123 = clojure.data.equality_partition.call(null,a);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__15123__$1)].join('')));
