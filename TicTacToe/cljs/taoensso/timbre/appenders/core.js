...
(taoensso.timbre.appenders.core.println_appender.cljs$core$IFn$_invoke$arity$variadic = (function (p__13560){
var vec__13561 = p__13560;
var _opts = cljs.core.nth.call(null,vec__13561,(0),null);
...
var map__13564 = data;
var map__13564__$1 = cljs.core.__destructure_map.call(null,map__13564);
var output_ = cljs.core.get.call(null,map__13564__$1,new cljs.core.Keyword(null,"output_","output_",-36797880));
...
/** @this {Function} */
(taoensso.timbre.appenders.core.println_appender.cljs$lang$applyTo = (function (seq13556){
...
var args__5732__auto__ = [];
var len__5726__auto___13590 = arguments.length;
var i__5727__auto___13591 = (0);
while(true){
if((i__5727__auto___13591 < len__5726__auto___13590)){
args__5732__auto__.push((arguments[i__5727__auto___13591]));

var G__13592 = (i__5727__auto___13591 + (1));
i__5727__auto___13591 = G__13592;
continue;
} else {
}
break;
...
(taoensso.timbre.appenders.core.console_appender.cljs$core$IFn$_invoke$arity$variadic = (function (p__13578){
var vec__13579 = p__13578;
var map__13582 = cljs.core.nth.call(null,vec__13579,(0),null);
var map__13582__$1 = cljs.core.__destructure_map.call(null,map__13582);
var raw_console_QMARK_ = cljs.core.get.call(null,map__13582__$1,new cljs.core.Keyword(null,"raw-console?","raw-console?",-2061489061));
...
var or__5002__auto__ = (function (){var G__13583 = level;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__13583__$1)].join('')));
...
/** @this {Function} */
(taoensso.timbre.appenders.core.console_appender.cljs$lang$applyTo = (function (seq13574){
var self__5712__auto__ = this;
return self__5712__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq13574));
}));
